...
//        if (!TextUtils.isEmpty(getText()) && !this.getText().equals("0.00")) {
//            ObjectAnimator objectAnimator = null;
//            if (Double.parseDouble(String.valueOf(this.getText())) > Double.parseDouble(String.valueOf(text))) {
//                objectAnimator = ObjectAnimator.ofObject(this, "backgroundColor",
//                        new ArgbEvaluator(),
//                        ContextCompat.getColor(getContext(), R.color.red),
//                        ContextCompat.getColor(getContext(), android.R.color.transparent));
//            } else if (Double.parseDouble(String.valueOf(this.getText())) < Double.parseDouble(String.valueOf(text))) {
//                objectAnimator = ObjectAnimator.ofObject(this, "backgroundColor",
//                        new ArgbEvaluator(),
