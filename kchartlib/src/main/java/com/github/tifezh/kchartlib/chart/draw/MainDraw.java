...
public class MainDraw extends BaseChartDraw<ICandle> {
    ...
    private void drawSelector(BaseKChartView view, Canvas canvas) {
        ...
        strings.add("high:   " + String.format("%.3f",point.getHighPrice()));
        strings.add("low:    " + String.format("%.3f",point.getLowPrice()));
        strings.add("open:  " + String.format("%.3f",point.getOpenPrice()));
        strings.add("close: " + String.format("%.3f",point.getClosePrice()));
